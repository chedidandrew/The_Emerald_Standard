...
- Advanced new and safely relocated replacement Banks to authored structure version 5. The v4 secure-record room remains intact, while a shaped front dormer, glazed bell cupola, articulated civic ridge, deep lobby-window reveals, paved forecourt wings, and rear ledger pediment give the Bank a deliberate public silhouette. New v5-only palette courses strengthen each biome identity: carved red sandstone and shade in Desert, neutral masonry against acacia in Savanna, moss-and-stone hierarchy in Taiga, pale cold trim against dark timber with a snow-aware crown in Snowy, and more masonry with less uninterrupted brown in Plains. Intact version-2, version-3, and version-4 Banks remain frozen against their own exact historical plans and are never reshaped or retro-lit in place.
