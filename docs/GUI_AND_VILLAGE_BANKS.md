...
Candidate sites must be loaded, naturally surfaced, dry, clear, and limited to two blocks of height variation. Project floors are placed above the highest surface rather than replacing terrain, while deterministic foundation cells bridge shallow drops and stop at sound natural ground. Unsafe candidates are skipped before reservation. Once a site is persisted, a later solid, protected, or unloaded placement defers construction with exponential backoff and retains the exact reservation—even at a recorded zero prefix—so a chunk write cannot be orphaned or duplicated. Housing and production effects remain inactive in visual mode until the authored structure is physically verified complete.
