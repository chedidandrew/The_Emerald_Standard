...
- Format-7 to format-8 project-catalog migration, format-8 to format-9 financial-state migration, format-9 to format-10 architecture migration that keeps completed, partial, and unstarted projects on `legacy_v1` without reroll or modular conversion, and format-10 to format-11 safe fallback-provenance migration
