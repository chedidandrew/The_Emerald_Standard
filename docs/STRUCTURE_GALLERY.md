...
The Structure Gallery is a developer-only review world that places every selected building immediately. It is intended for fast visual inspection and screenshots; it does not simulate village growth. The main matrix always follows the active catalog, which is currently 52 revision-2 masters spanning small, medium, large, and landmark scales; retired revision-1 plans remain available to saved gameplay projects but are intentionally not mixed into the active review matrix.
...
.\fabric\gradlew.bat --no-daemon -p .\fabric `
  -I .\scripts\structure-gallery-client.init.gradle `
...
```powershell
.\fabric\gradlew.bat --no-daemon -p .\fabric `
  -I .\scripts\structure-gallery-capture-client.init.gradle `
  -PtesGalleryGameDir="$PWD\fabric\run\gallery-26.2" `
...
| ---: | --- | --- |
| 1–260 | Gold-master matrix | Fifty-two complete active revision-2 blueprints rendered at full visual stage with prosperous production dressing, once in each of the five biome dialects. No floorplan, roof, frontage, or interior is recombined. |
| 261–271 | Controlled Blueprint lab | The revision-2 `house_cross_01` Plains House compared one axis at a time across stages, semantic palettes, dressing kits, approved mirroring, and all four rotations. |
...
| ---: | --- | --- |
| 1 | `cottage_hearth_01@2` | Asymmetric saltbox cottage with a dominant masonry hearth and shed wing |
| 2 | `cottage_garden_02@2` | Garden cottage with a glasshouse, pergola, and clipped gable |
| 3 | `cottage_courtyard_03@2` | Large courtyard residence with offset wings, layered gables, porch, and garden enclosure |
| 4 | `cottage_bay_04@2` | Compact bay-window cottage with a sheltered stoop and dense domestic detail |
| 5 | `house_cross_01@2` | True cross footprint with crossed gables and a raised lantern |
| 6 | `house_dormer_02@2` | Tall mansard house with dormers and a projecting bay |
| 7 | `house_arcade_03@2` | Large arcaded residence with a multi-mass roofline and formal frontage |
| 8 | `house_hall_04@2` | Compact hall house with an emphasized hearth, porch, and readable interior |
| 9 | `inn_gallery_01@2` | Broad U-plan inn with a sheltered gallery and gatehouse frontage |
| 10 | `inn_coachhouse_02@2` | Grand coachhouse inn with carriage court, balconies, and multiple public rooms |
| 11 | `inn_wayfarer_03@2` | Small roadside inn with a covered entry and compact guest hall |
| 12 | `warehouse_bay_01@2` | Three-bay warehouse with a monitor roof, loading dock, and hoist |
| 13 | `warehouse_crane_02@2` | Large quay warehouse with a crane, loading galleries, and layered storage bays |
| 14 | `warehouse_gabled_03@2` | Compact gabled warehouse with a strong loading front and practical storage interior |
| 15 | `granary_loft_01@2` | Raised granary with an open undercroft, loft, and grain chute |
| 16 | `granary_windmill_02@2` | Landmark windmill granary with a tall mill tower, sail cross, and grain works |
| 17 | `granary_cruck_03@2` | Compact cruck-framed granary with raised storage and loading details |
| 18 | `smithy_courtyard_01@2` | Open L-plan smithy yard with twin forge flues |
| 19 | `smithy_hammerhall_02@2` | Grand hammer hall with an open forge loggia, work bays, and prominent chimneys |
| 20 | `smithy_lane_03@2` | Compact lane smithy with a working forge, side shelter, and material yard |
| 21 | `mine_headframe_01@2` | Freestanding headframe, adit, rails, and side tool sheds |
| 22 | `mine_winding_house_02@2` | Large winding house with headframe, rails, machinery bays, and service sheds |
| 23 | `mine_adit_03@2` | Compact adit works with rail access, timber shoring, and tool staging |
| 24 | `market_cloister_01@2` | Arcaded market with distinct bays and a central bell rotunda |
| 25 | `market_guildcourt_02@2` | Grand guild court with a formal arcade, pavilion, stalls, and civic centerpiece |
| 26 | `market_crossroads_03@2` | Compact crossroads market with readable stalls, shelter, and public circulation |
| 27 | `guard_watch_01@2` | Battered masonry guard tower with an overhanging timber watch room |
| 28 | `guard_bastion_02@2` | Landmark bastion with twin defensive masses, elevated watch spaces, and battlements |
| 29 | `guard_blockhouse_03@2` | Compact blockhouse with a tall watch profile and defensible entrance |
| 30 | `exchange_hall_01@2` | Basilica-like civic hall with aisles, clerestory, portico, and cupola |
| 31 | `exchange_countinghouse_02@2` | Grand countinghouse with wings, dormers, teller rail, offices, and a civic facade |
| 32 | `exchange_branch_03@2` | Compact branch exchange with a clear public counter and focused banking interior |
| 33 | `cottage_longhouse_05@2` | Low linear longhouse with a deep hearth, framed bays, and an attached working yard |
| 34 | `cottage_orchardstead_06@2` | Large orchard estate with offset domestic wings, garden frontage, and layered rural roofs |
| 35 | `house_splitwing_05@2` | Split-wing residence with a recessed entrance court and independently expressed roof masses |
| 36 | `house_towercourt_06@2` | Landmark courtyard manor organized around a tall residential tower and formal gallery |
| 37 | `inn_tavern_04@2` | Established roadside tavern with a public porch, taproom mass, guest wing, and service yard |
| 38 | `inn_courtyard_05@2` | Landmark courtyard inn with multiple lodging wings, balconies, carriage access, and a civic-scale roofline |
| 39 | `warehouse_wharf_04@2` | Wharf warehouse with stepped loading decks, strong storage bays, hoist details, and practical interior circulation |
| 40 | `warehouse_basilica_05@2` | Landmark aisled warehouse with clerestory storage hall, loading nave, and monumental trade frontage |
| 41 | `granary_stilt_04@2` | Raised stilt granary with a ventilated undercroft, external loading access, and distinct grain handling details |
| 42 | `granary_silocomplex_05@2` | Large multi-volume silo complex with elevated links, processing bays, and a dominant agricultural silhouette |
| 43 | `smithy_corner_04@2` | Corner smithy with an open forge court, covered work bays, material racks, and a compact chimney profile |
| 44 | `smithy_foundry_05@2` | Landmark foundry with furnace hall, tall stacks, gantries, casting yard, and heavy industrial massing |
| 45 | `mine_drift_04@2` | Drift-mine works with a fortified adit, rail approach, timber sheds, and visible ore-handling equipment |
| 46 | `mine_quarry_05@2` | Large quarry complex with a broad cutting yard, machine house, raised hoists, and layered service structures |
| 47 | `market_lane_04@2` | Linear market lane with varied covered stalls, merchant storage, strong entrances, and open public circulation |
| 48 | `market_bazaar_05@2` | Landmark covered bazaar with multiple courts, arcades, pavilion roofs, and a central civic focus |
| 49 | `guard_gatehouse_04@2` | Defensible gatehouse with a pass-through arch, flanking watch rooms, battlements, and guard fixtures |
| 50 | `guard_citadel_05@2` | Landmark citadel with layered defensive masses, elevated patrol spaces, towers, and commanding rooflines |
| 51 | `exchange_loggia_04@2` | Large exchange loggia with an arcaded public frontage, teller hall, offices, and a clear civic identity |
| 52 | `exchange_bourse_05@2` | Monumental bourse with a grand trading floor, deep portico, offices, roof lantern, and skyline-defining massing |
