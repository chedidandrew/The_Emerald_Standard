...
public final class SettingsHelp {
    ...
    public static String description(String key) {
        String help = switch (key) {
            ...
            case "village_prosperity.development_radius" -> "Horizontal distance for village discovery, automatic Bank construction and village development. Banks use the village center, including while work continues. Higher activates more nearby work; terrain must still be loaded. Range: 48–512.";
            case "village_prosperity.construction_blocks_per_second" -> "Target block operations per second for EACH active construction site, including Banks, at 20 server ticks per second. Clearing blocks counts too. Crews share available building time, so busy worlds can progress more slowly. Higher targets allow faster work when time is available. Paused or absent crews do not store unused work. Range: 1–100.";
